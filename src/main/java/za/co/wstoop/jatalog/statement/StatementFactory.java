...
/**
 * Provides factory methods for building Statement instances for use with the
 * fluent API.
 * <p>
 * {@link Jatalog#prepareStatement(String)} can be used to parse Strings to
 * statement object.
 * </p>
 *
 * @see Statement
...
public class StatementFactory {
     ...
     * @return A statement that will delete facts matching the goals from the
     * database.
     */
