 ...
 * <p>
 * There are several types of statements: to insert facts, to insert rules, to
 * retract facts and to query the database.
 * </p><p>
 * Instances of Statement are created by {@link StatementFactory}.
 * </p><p>
 * Strings can be parsed to Statements through
 * {@link Jatalog#prepareStatement(String)}
 * </p>
 *
...
public interface Statement {
     ...
     * <ul>
     * <li> If null, the statement was an insert or delete that didn't produce
     * query results.
     ...
     * </ul>
     * Jatalog provides a {@link OutputUtils#answersToString(Collection)} method
     * that can convert answers to Strings
     ...
     */
    public default Collection<Map<String, String>> execute(Jatalog datalog) throws DatalogException {
