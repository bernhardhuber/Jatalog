 ...
 * <li> Trying to add invalid facts or rules to the database. For example, facts
 * are invalid if they are not ground and rules are invalid if variables in the
 * head don't appear in the body.
 * <li> Using built-in predicates in invalid ways, such as comparing unbound
 * variables.
 * </ul>
 */
